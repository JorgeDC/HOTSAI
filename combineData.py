...
data_path = 'hotslogs_data/ReplayCharacters.csv'
#data_path = 'hotslogs_dataset.csv'
sys.stdout.write("\rLoading")
hots_pre = np.array(pd.read_csv(data_path))

data_path_replays = 'hotslogs_data/Replays.csv'
...
np.savetxt('training_data/all_data.csv', hots_final, fmt='%s', delimiter=",")
